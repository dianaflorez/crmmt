			...
			<tr class="<?php if(!$formulario->estado) echo 'success'; ?>">
				...
				<td>
					<p class="text-center">
						...
						<?php if($formulario->estado) echo CHtml::link('<i class="fa fa-eye fa-lg fa-border"></i>', Yii::app()->createUrl('formulario/enviar/', array('id'=>$formulario->id_for)), array('data-toggle'=>'tooltip', 'title'=>"Ver encuesta"));  ?>
